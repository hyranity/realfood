...
<html>
    ...
    <body>
        <div class="dashboardContainer">
            <h1>Welcome, Vivian <span class="badge badge-light">School Staff</span></h1>
            <h4 id="subtitle">Here's your dashboard.</h4>
            <div class="buttonsContainer">
                <a href="#"><div class="buttonDiv" id="student">manage students</div></a>
    ...
    <script>
        $(document).ready(function () {
            $("#student").hover(function () {
                $("#subtitle").html("That is where you can add and edit the enrolment status of sudents.");
            }, function () {
