    ...
    <body>
        <%
            ...
            if (session.getAttribute("permission") == null) {
                ...
                String dateDiscontinued = Auto.dateToString(meal.getDatediscontinued());
        ...
        <div class="outsideContainer"><br/><br/><br/>
            ...
            <div class="mainContainer">
                ...
                <form action="MealDetailsEditServlet" class="form">
                    ...
                    <div>
                        <input type="text" value="<%=id%>" style="background-color: darkgray;"  id="mealId" required/>
                    </div>
                    <div>
                        <input type="text" id="mealName" value="<%=name%>" placeholder="Meal Name"  required/>
                    </div>
                    <div>
                        <input type="text" value="<%=description%>" id="description" placeholder="Meal Description" required/>
                    </div>
                    <div>
                        <input type="number" value="<%=price%>" id="price" placeholder="Price"/>
                    </div>
                    <div>
                        <input type="text" value="<%=imageLink%>" id="imageLink" placeholder="Image Link" required/>
                    </div>
                    <div>
                    ...
                    <div class="mealTime" style="margin-top: 50px;">
                        ...
                        %>
                        <input type="checkbox" value="" id="breakfast" name="breakfast" checked/>
                        <%} else {%>
                        ...
                        %>
                        <input type="checkbox" value="" id="lunch" name="lunch" checked/>
                        <%} else {%>
