<%-- 
    Document   : orderPreparation
    Created on : Apr 4, 2019, 7:39:58 PM
    Author     : Richard Khoo
--%>
            ...
            <tr>
                <td>
                    <div class="record">
                        ...
                        <p>Honey Mustard</p>
                        <p>120 calories</p>
                        <a href=""><div class="editButton">Mark As Done</div></a>
                    </div>
                </td>
                <td>
                    <div class="record">
                        ...
                        <p>120 calories</p>
                        <br/>
                        <p class="status" style="color: red; font-weight: bold;">Done</p>
                        <a href=""><div class="editButton">Mark As Done</div></a>
                    </div>
                </td>
            </tr>
